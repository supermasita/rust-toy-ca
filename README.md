# rust-toy-ca
This is a toy service made using [Warp](https://github.com/seanmonstar/warp) and OpenSSL: it will take a CSR as input and return a certificate signed by the Certificate Authority (CA) credentials you provide.
...
## Running with Docker
Not that you can find the latest Docker image at in [Docker Hub](https://hub.docker.com/repository/docker/supermasita/rust-toy-ca).
